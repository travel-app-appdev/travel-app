...
//                   >
//                     {/* Badge + timer block sit side by side, both centred vertically */}
...
//                       {/*
//                         Timer block layout (matches screenshot):

//                         [ hourglass ]  [ 73 days left ] [ • ]
//                                        [ Timer         ]

//                         The hourglass spans both rows via alignSelf stretch,
//                         the text column stacks days + Timer label.
//                       */}
//                       <View style={styles.phaseTimerBlock}>
//                         {/* Hourglass — sits left, vertically centred across both text rows */}
...
//                         {/* Text column: days on top, "Timer" below */}
...
//   // Phase row — badge + timer block side by side
//   phaseRow: {
//     flexDirection: "row",
//     alignItems: "center",
//     justifyContent: "space-between",
...
//   // Timer block: hourglass column + text column side by side
//   phaseTimerBlock: {
//     flexDirection: "row",
//     alignItems: "center",
//     gap: spacing.xs,
//   },
//   hourglassCol: {
//     // Vertically centred alongside the two-line text column
//     justifyContent: "center",
//     alignItems: "center",
//   },
//   phaseTextCol: {
...
//   },
//   timepointWrapper: {
//     // Raised dot — sits at the top-right of the days text
//     marginTop: 1,
//   },
//   timerLabel: {
