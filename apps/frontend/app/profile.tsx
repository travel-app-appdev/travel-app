        ...
        >
          ...
          <View style={styles.header}>
            ...
            <View style={styles.headerTitle}>
              ...
              <AppText variant="body" style={styles.headerLabel}>Profile</AppText>
            </View>
          </View>
            ...
            >
              <View style={styles.infoLeft}>
                <View style={styles.infoLabelRow}>
                  ...
                  <AppText variant="body" style={styles.fieldLabel}>Name</AppText>
                </View>
                <AppText variant="caption" style={styles.infoValue}>{name}</AppText>
              </View>
              {nameOpen
            ...
            {nameOpen && (
              <View style={styles.expandedField}>
                <TextInput
                  style={styles.input}
                  value={nameInput}
                  onChangeText={(text) => { setNameInput(text); setNameUpdated(false); }}
            ...
            >
              <View style={styles.infoLeft}>
                <View style={styles.infoLabelRow}>
                  ...
                  <AppText variant="body" style={styles.fieldLabel}>Email</AppText>
                </View>
                <AppText variant="caption" style={styles.infoValue}>{email}</AppText>
              </View>
              {emailOpen
                ? <ArrowDown width={20} height={20} />
                : <ArrowRight width={20} height={20} />}
            ...
            {emailOpen && (
              <View style={styles.expandedField}>
                <TextInput
                  style={styles.input}
                  value={emailInput}
                  onChangeText={(text) => { setEmailInput(text); setEmailUpdated(false); }}
                  placeholderTextColor={colors.textMuted}
            ...
            >
              <View style={styles.infoLeft}>
                <View style={styles.infoLabelRow}>
                  ...
                  <AppText variant="body" style={styles.fieldLabel}>Password</AppText>
                </View>
              ...
              <View style={styles.expandedField}>
                <View style={styles.passwordInputWrapper}>
                  <TextInput
                    ...
                    value={passwordInput}
                    onChangeText={(text) => { setPasswordInput(text); setPasswordUpdated(false); }}
